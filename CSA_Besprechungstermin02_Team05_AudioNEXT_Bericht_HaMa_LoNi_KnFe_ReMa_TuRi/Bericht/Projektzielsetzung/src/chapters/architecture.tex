...
Dazu wird je Audio Kanal ein Interrupts ausgelöst, wenn ein neuer Wert vorhanden ist.
...
Wenn eine über die AXI Lite Schnittstelle geschriebener Lautstärke verarbeitet wurde, wird ein Interrupt ausgelöst.
