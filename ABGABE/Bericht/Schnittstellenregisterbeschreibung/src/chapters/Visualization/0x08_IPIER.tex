...
\begin{itemize}
    ...
    \item \textbf{Bit 0 - FIE: Frame Data Processed Interrupt Enable}\\
    Wenn dieses Bit auf 1 gesetzt wird, ist der Frame Data Processed Interrupt aktiviert.
    Er wird ausgelöst, wenn das FDP Bit in IPISR gesetzt wird.
