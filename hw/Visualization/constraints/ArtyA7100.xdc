...
#set_property ASYNC_REG TRUE [get_cells { VGA_INST/s_cdc_vga_en_reg }];
#set_property ASYNC_REG TRUE [get_cells { VGA_INST/s_vga_en_reg }];
...
set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports { o_hsync }]; #IO_L22P_T3_A05_D21_14 Sch=jc_p[3]
set_property -dict { PACKAGE_PIN V14   IOSTANDARD LVCMOS33 } [get_ports { o_vsync }]; #IO_L22N_T3_A04_D20_14 Sch=jc_n[3]
